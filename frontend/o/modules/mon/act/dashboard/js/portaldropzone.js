...
*/
Ext.define('O.mon.act.dashboard.PortalDropZone', {
	extend: 'Ext.dd.DropTarget',
	alias: 'widget.portaldropzone',

	constructor: function(portal, cfg) {
		this.portal = portal;
		Ext.dd.ScrollManager.register(portal.body);
		O.mon.act.dashboard.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
	...
	unreg: function() {
		...
		O.mon.act.dashboard.PortalDropZone.superclass.unreg.call(this);
	}
});