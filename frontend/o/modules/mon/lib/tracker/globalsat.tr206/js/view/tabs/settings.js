/**
 * @class O.mon.lib.tracker.globalsat.tr206.tab.Settings
 * @extends O.mon.lib.tracker.globalsat.tab.Settings
 */

Ext.define('O.mon.lib.tracker.globalsat.tr206.tab.Settings', {
	extend: 'O.mon.lib.tracker.globalsat.tab.Settings',
	alias: 'widget.mon-lib-tracker-globalsat.tr206-tab-settings',
